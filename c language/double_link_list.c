...
int search(int val)
{
	...
	else
	{
		...
		if(k==0)
		{
			printf("Thenumberisnotpresentinthelist\n");
			return 0;
		}
	}
}
...
while(1)
{
	...
	switch(ch)
	{
		...
		case 3:
			val=deletion_begin();
			printf("Thedeletedvalueis%d",val);
			break;
		case 4:
			val=deletion_end();
			printf("Thedeletedvalueis%d",val);
		...
		case 6:
			printf("Enterthevaluetoenter\n");
			scanf("%d",&val);
			printf("Enterthepositiontoenter\n");
			scanf("%d",&pos);
			ins_at_any(val,pos);
			break;
		case 7:
			printf("Enterthepositiontodeletevalue\n");
			scanf("%d",&pos);
			val=del_at_any(pos);
			printf("Thedeletedvalueis%d",val);
			break;
		case 8:
			printf("Thevaluetosearchinthelist\n");
			scanf("%d",&val);
			pos=search(val);
			printf("Thevaluesearchedisin%dthposition\n",pos);
			break;
		case 9:
			printf("Endofthelist\n");
			exit(0);
